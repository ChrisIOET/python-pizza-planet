...
def test_size_controller__returns_new_size(app, size: dict):
...
def test_size_controller__returns_updated_size__when_current_size_name_is_random_and_price_ten(
    app, size: dict
):
...
def test_size_controller__return_size__when_id_is_called(app, size: dict):
...
def test_size_controller__returns_new_sizes(app, sizes: list):
